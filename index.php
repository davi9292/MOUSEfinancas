                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"> 
                     <a class="nav-link fw-semibold" href="#" onclick="showSection('investment')">
                           <i class="bi bi-safe me-1"></i> Investimento
                     </a>
                    </li>
            ...
            <div class="container">
                ...
                <div class="row align-items-center min-vh-100 py-5">
                    <div class="col-lg-6 order-lg-1 order-2">
                        ...
                        <p class="lead text-muted mb-4">
                            MOUSEFinanças é sua plataforma completa para educação financeira, simulações e gestão de despesas. 
                ...
                <div class="row g-4 py-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card h-100 text-center p-4 rounded-4 shadow-sm" onclick="showSection('expenses')">
                            <i class="bi bi-wallet text-success mb-3" style="font-size: 3rem;"></i>
                            <h5 class="fw-bold text-primary">Gerenciador de Despesas</h5>
                            <p class="text-muted">Controle suas despesas por categoria e visualize relatórios mensais com gráficos interativos.</p>
                        </div>
                    </div>
                    
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card h-100 text-center p-4 rounded-4 shadow-sm" onclick="showSection('financing')">
                            ...
                            <p class="text-muted">Simule financiamentos imobiliários, veiculares e pessoais com sistemas SAC e PRICE.</p>
                        </div>
                    </div>
                    
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card h-100 text-center p-4 rounded-4 shadow-sm" onclick="showSection('investment')">
                            ...
                            <p class="text-muted">Projete seus investimentos com juros compostos e visualize o crescimento ao longo do tempo.</p>
                        </div>
                    </div>
                    
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-card h-100 text-center p-4 rounded-4 shadow-sm" onclick="showSection('education')">
                            <i class="bi bi-book text-success mb-3" style="font-size: 3rem;"></i>
                            <h5 class="fw-bold text-primary">Educação Financeira</h5>
                            <p class="text-muted">Aprenda conceitos fundamentais através de vídeos educativos e resumos práticos.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form id="investment-form">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="initial_amount" step="0.01" placeholder="0">
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">Aporte Mensal (R$)</label>
                                        <input type="number" class="form-control" name="monthly_contribution" step="0.01" placeholder="0">
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label class="form-label">Taxa de Retorno Anual (%)</label>
                                        <input type="number" class="form-control" name="annual_return_rate" step="0.01" required>
                                    </div>
...
$topics = [
    [
        ...
        "video_url" => "https://www.youtube.com/embed/hC-Bt9N1PW8",
    ...
    [
        ...
        "video_url" => "https://www.youtube.com/embed/Qm6HdD7sY1c",
    ...
    [
        ...
        "video_url" => "https://www.youtube.com/embed/qBgK1tRAPzA",
    ...
    [
        ...
        "video_url" => "https://www.youtube.com/embed/X7XLmEGswGY?si=_PwwsExPGmj0_djH",
        "summary" => "Use a regra 50-30-20: 50% para necessidades (moradia, alimentação), 30% para desejos (lazer, compras), 20% para poupança e investimentos. Controle regular é essencial."
    ],
];
?>
...
<?php foreach ($topics as $topic): ?>
    <div class="col-lg-6">
        <div class="education-card shadow-sm rounded-4 h-100">
            <div class="video-container" style="min-height:220px;">
                <iframe width="100%" height="315"
                    ...
                    allowfullscreen
                    style="border-radius: .5rem .5rem 0 0;"></iframe>
            </div>

            <div class="p-4">
                <h5 class="fw-bold text-primary"><?= htmlspecialchars($topic['title']) ?></h5>
                <p class="text-muted mb-3"><?= htmlspecialchars($topic['description']) ?></p>

                <div class="education-summary">
                    <h6 class="fw-bold mb-2">Resumo:</h6>
                    <p class="mb-0"><?= htmlspecialchars($topic['summary']) ?></p>
                </div>
            </div>
        </div>
    </div>
